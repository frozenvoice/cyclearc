...
Cursor 위젯은 **Cursor Models → Other Models → Grok Bot** 순서로 제공된 한도를 최대 세 개까지 표시하며 월간·주간으로 묶습니다. 링 아래에는 해당 한도 이름을 표시합니다. 꺼진 온디맨드와 다른 예산 항목, 정확한 리셋·업데이트 시각은 툴팁과 상세 팝업에서 확인할 수 있습니다. 위젯의 갱신 상태는 짧은 경과 시간으로 표시하고, 미확인값·오래된 데이터·인증 오류는 계속 명시합니다.
